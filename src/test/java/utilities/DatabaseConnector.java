...
public class DatabaseConnector {
    ...
    private static final String dbusername = ConfigReader.getProperty("DB_username");
    private static final String dbpassword = ConfigReader.getProperty("DB_password");
    private static final String connectionUrl = ConfigReader.getProperty("db_url");
